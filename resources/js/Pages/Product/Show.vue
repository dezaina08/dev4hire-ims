                        ...
                        <div class="py-4 lg:py-6 p-4 bg-white rounded-lg shadow">
                            ...
                            <div>
                                <div class="mb-2 flex flex-col items-center">
                                    <img :src="model.product_photo != null & model.product_photo != '' ? model.product_photo : '/product-no-image.png'"
                                        class="w-44 h-44 object-cover border border-gray-300 mb-2 rounded-md" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                <div class="grid gap-4 md:grid-cols-2 sm:gap-6 mb-5">
                                    <div class="">
                                        ...
                                        <TextInput id="name" type="text" class="mt-1 block w-full h-10 bg-gray-100"
                                            v-model="model.name" required autofocus autocomplete="off" placeholder="Name"
                                            disabled />
                                    </div>
                                    <div class="">
                                        <InputLabel for="product_code" value="Product Code" />
                                        <TextInput id="product_code" type="text" class="mt-1 block w-full h-10 bg-gray-100"
                                            v-model="model.product_code" required autocomplete="off"
                                ...
                                <div class="grid gap-4 md:grid-cols-2 sm:gap-6 mb-5">
                                    <div class="">
                                        ...
                                        <TextInput id="category_id" type="text" class="mt-1 block w-full h-10 bg-gray-100"
                                            v-model="model.category.name" required autocomplete="off" placeholder="Category"
                                            disabled />
                                    </div>
                                    <div class="">
                                ...
                                <div class="grid gap-4 md:grid-cols-2 sm:gap-6 mb-5">
                                    <div class="">
                                        <InputLabel for="buying_price" value="Buying Price" />
                                        <TextInput id="buying_price" type="text" class="mt-1 block w-full h-10 bg-gray-100"
                                            v-model="model.buying_price" required autocomplete="off"
                                            placeholder="Buying Price" disabled />
                                    </div>
                                    <div class="">
                                        <InputLabel for="selling_price" value="Selling Price" />
                                        <TextInput id="selling_price" type="text" class="mt-1 block w-full h-10 bg-gray-100"
                                            v-model="model.selling_price" required autocomplete="off"
                                ...
                                <div class="grid gap-4 md:grid-cols-2 sm:gap-6 mb-5">
                                    <div class="">
                                        ...
                                        <TextInput id="stock" type="text" class="mt-1 block w-full h-10 bg-gray-100"
